...
//  MapKitTutorial
//
//  Created by Zohar Mosseri on 29/11/2023.
//
...
/*
final class SingleChatViewController: MessagesViewController {
    ...
    private var selfSender: Sender? {
        ...
        let safeEmail = DatabaseManager.makeSafeEmail(email)
...
extension SingleChatViewController: InputBarAccessoryViewDelegate {
    ...
    private func createMessageId() -> String? {
        ...
        let safeCurrentEmail = DatabaseManager.makeSafeEmail(currentUserEmail)
...
extension SingleChatViewController: MessagesDataSource, MessagesLayoutDelegate, MessagesDisplayDelegate {
    ...
    //that's how the chat knows to present the message on the right or on the left depends on sender/reciever
